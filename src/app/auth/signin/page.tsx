      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Sign in to continue to Copilot
          </p>
        </div>
        ...
        >
          ...
          {/* Demo notice */}
          <div className="mt-4 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-sm text-center">
            Demo mode: You can use the app without signing in
          </div>
